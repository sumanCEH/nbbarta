...
<html lang="en">
 ...
 #scrolltoTop :hover{
  ...
  <body onload="startTime()">
    ...
    <!-----Navigation-Bar-->
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-dark py-2">
      ...
      >
        <ul class="navbar-nav px-3 ml-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="category-1.php active">Covid 19 <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
...
<?php 
echo " <br/><br/><br/><br/>";
      $sql2 = "SELECT * FROM news  WHERE cat_id = 1 ORDER BY news_id DESC";
